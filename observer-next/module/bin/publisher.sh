...
publish_cc() {
  ...
  _expected_apk="$(pub_kv EXPECTED_APK_VERSION_CODE "$_handshake")"; [ -n "$_expected_apk" ] || _expected_apk=110
  ...
  _tmp="$_out.tmp.$PPID"
  {
    ...
    echo "CONTRACT=DJAEGER_AI_ADAPTIVE_V3"; echo "MODULE_VERSION_CODE=$_module_code"; echo "EXPECTED_CONTROL_CENTER_VERSION_CODE=110"; echo "CONTROL_CENTER_VERSION_CODE=${_apk_ver:-UNVERIFIED}"

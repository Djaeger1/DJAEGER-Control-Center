...
SYNC_OUT=$(run_ctl sync-request 108 DJAEGER_AI_ADAPTIVE_V3 contract-test-1)
...
grep -Fqx 'MODULE_VERSION_CODE=207' "$SNAPSHOT"
grep -Fqx 'CONTROL_CENTER_VERSION_CODE=108' "$SNAPSHOT"

...
grep -Fq 'publish WAITING candidate_missing; sleep 10' "$MODULE/bin/shadow_contextual_v4.sh"
grep -Fq 'publish WAITING insufficient_contextual_evidence' "$MODULE/bin/shadow_contextual_v4.sh"
...
grep -Fq 'ONE HERMES Cloud remains' "$MODULE/bin/hermes_adapter.sh"
...
grep -Fq 'intent=="POWER_EFFICIENCY"' "$MODULE/bin/shadow_contextual_v4.sh"
grep -Fq 'intent=="FRAME_RECOVERY"' "$MODULE/bin/shadow_contextual_v4.sh"
...
grep -Fq 'echo "ACTUATORS=$(kv ACTUATORS "$POLICY")"' "$MODULE/bin/shadow_contextual_v4.sh"
grep -Fq '_approved_digest="$(kv CANDIDATE_DIGEST "$APPROVAL")"' "$MODULE/bin/shadow_contextual_v4.sh"
grep -Fq 'rm -f "$APPROVAL"' "$MODULE/bin/shadow_contextual_v4.sh"
...
grep -Fq 'djaeger_singleton_claim shadow_contextual_v4' "$MODULE/bin/shadow_contextual_v4.sh"
...
grep -Fq 'human_comfort_frame_first_minimum_power' "$MODULE/bin/shadow_contextual_v4.sh"
...
grep -Fq 'comfort==1 && intent!="FRAME_RECOVERY"' "$MODULE/bin/shadow_contextual_v4.sh"

...
grep -Fq 'MEMORY_RESERVE_BYTES=4194304' "$MODULE/bin/observer.sh"
grep -Fq 'TOTAL_MEMORY_BYTES=$((SIZE+AUX_BYTES))' "$MODULE/bin/observer.sh"
grep -Fq 'TELEMETRY_TARGET=$((MEMORY_MAX_BYTES-AUX_BYTES-MEMORY_RESERVE_BYTES))' "$MODULE/bin/observer.sh"
grep -Fq 'OUTCOMES_MAX_BYTES=8388608' "$MODULE/bin/executor.sh"
grep -Fq 'OUTCOMES_RETAIN_BYTES=6291456' "$MODULE/bin/executor.sh"

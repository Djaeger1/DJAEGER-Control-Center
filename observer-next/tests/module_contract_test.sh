...
mkdir -p "$LEGACY_ROOT/config" "$LEGACY_ROOT/hermes" "$FOREIGN_A" "$FOREIGN_B" "$LEGACY_MODULE_ROOT/system/etc/djaeger/railway"
...
echo 'module-contract-tests=PASS'
 "$TEST_ROOT/config/gemini_cooldown.env"

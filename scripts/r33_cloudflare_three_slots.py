...
for x in ['Text("SLOT 1")','Text("SLOT 2")','Text("SLOT 3")','CLOUDFLARE_SELECT','CLOUDFLARE_REMOVE','saveCloudflareCredentialsSlot(cloudflareSlot']:
    assert x in ms, 'R33 slot UI missing: '+x
m.write_text(ms)

print('R33_CLOUDFLARE_SLOTS=3')
print('R33_SLOT_SELECTION=MANUAL')

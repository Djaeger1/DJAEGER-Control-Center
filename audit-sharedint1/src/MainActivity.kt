...
@Composable fun HermesCard(s:RuntimeState){
    ...
    val syncMatched=syncContract=="REBUILD3_LANG3_MWFIX2_ATTR1_MATH1_HK1_SYSFS1_CCSYNC1"&&syncModule=="129631"&&syncCc=="12258"
    ...
    val authority=if(currentBrain=="GEMINI") "SHADOW LEARNING • GEMINI HAS DECISION AUTHORITY" else "DEPUTY LOCAL BRAIN • ACTIVE ONLY WHEN GEMINI UNAVAILABLE • NO DIRECT HARDWARE WRITES"

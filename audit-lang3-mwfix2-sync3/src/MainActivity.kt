...
@Composable fun HermesCard(s:RuntimeState){
    ...
    val syncMatched=syncContract=="REBUILD3_LANG3_MWFIX2_MATH1_SYNC3"&&syncModule=="129629"&&syncCc=="12256"
